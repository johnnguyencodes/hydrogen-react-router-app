export function PlantPageDescription({
  ...
  return (
    <div className="lg:col-start-2 lg:row-start-2">
      <div className="rounded-md lg:bg-[var(--color-bg-3)] prose prose-p:text-[var(--color-fg-text)] prose-p:text-sm text-base prose-strong:text-[var(--color-fg-blue)] lg:top-4 lg:sticky">
        <div
